...
<body>
	...
	<div id="home">
		...
		<div id="create">
			...
			<?php echo form_open_multipart('index.php/article/create'); ?>

			<label for="title">Title</label></br>
			<input type="input" name="title" id='title' /><br /><br>

			<label for="text">Text</label></br>
			<textarea name="text" id='text' rows="10" cols="50"></textarea><br /><br>

			<label for="file">Picture</label></br>
			<input type="file" name="userfile" id="file"/><br><br>

			<input type="submit" name="submit"  value="Create article item" /><br><br>
